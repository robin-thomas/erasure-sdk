...
import OneWayGriefing_Factory from "../../src/contracts/OneWayGriefing_Factory";

import config from "../../src/keys.json";

describe("OneWayGriefing_Factory", () => {
  ...
  const ratio = 0;
  const ratioType = 1;
  const counterParty = "0x060D43a58EB3E9049806519F9741527Cf82791f8";
  ...
  describe("#createExplicit", () => {
    it("", async () => {
      const contract = new OneWayGriefing_Factory({ network, web3 });
